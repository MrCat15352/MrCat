...
ID мода: CELADON_STARSECTOR_TURRETS
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/starsector_turrets.dm`: `STARSECTOR_TURRETS_SPEED_MULTIPLIER`, `STARSECTOR_TURRETS_SPEED_BASE`
-->
