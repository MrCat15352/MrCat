...
/datum/modpack/starsector_turrets
...
// Инициализация ДО
/datum/modpack/starsector_turrets/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/starsector_turrets/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/starsector_turrets/post_initialize()
	. = ..()
