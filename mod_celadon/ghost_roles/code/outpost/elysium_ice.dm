...
/obj/effect/mob_spawn/human/elysium_outpost/cook/Destroy()
	var/obj/machinery/cryopod/outpost/cook/new_cryopod = new(drop_location())
	if(replenish_role)
...
/obj/effect/mob_spawn/human/elysium_outpost/bartender/Destroy()
	var/obj/machinery/cryopod/outpost/bartender/new_cryopod = new(drop_location())
	if(replenish_role)
		new_cryopod.linked_spawner_type = type
	return ..()
...
/obj/effect/mob_spawn/human/elysium_outpost/maid/Destroy()
	var/obj/machinery/cryopod/outpost/maid/new_cryopod = new(drop_location())
	if(replenish_role)
		new_cryopod.linked_spawner_type = type
	return ..()
...
/obj/effect/mob_spawn/human/elysium_outpost/artist/Destroy()
	var/obj/machinery/cryopod/outpost/artist/new_cryopod = new(drop_location())
	if(replenish_role)
		new_cryopod.linked_spawner_type = type
	return ..()
...
/obj/effect/mob_spawn/human/elysium_outpost/wagabond/Destroy()
	var/obj/structure/bed/outpost/wagabond/new_bed = new(drop_location())
	if(replenish_role)
...
/obj/effect/mob_spawn/human/elysium_outpost/medic/Destroy()
	var/obj/machinery/cryopod/outpost/medic/new_cryopod = new(drop_location())
	if(replenish_role)
		new_cryopod.linked_spawner_type = type
	return ..()
