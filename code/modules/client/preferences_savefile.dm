...
/datum/preferences/proc/update_character(current_version, savefile/S)
	...
	if(current_version < 42)
		...
		if(species_id == "tajaran")
			...
			READ_FILE(S["feature_tajaran_noise_markings"]	, features["tajaran_noise_markings"])
...
/datum/preferences/proc/load_character(slot)
	...
	features["tajaran_noise_markings"]		= sanitize_inlist(features["tajaran_noise_markings"], GLOB.tajaran_noise_markings_list, "None")
...
/datum/preferences/proc/save_character()
	...
	WRITE_FILE(S["feature_tajaran_noise_markings"]		, features["tajaran_noise_markings"])
